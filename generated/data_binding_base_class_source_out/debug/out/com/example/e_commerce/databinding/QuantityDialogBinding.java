...
public final class QuantityDialogBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView quntityBtn;

  @NonNull
  public final Button saveBtn;

  private QuantityDialogBinding(@NonNull ConstraintLayout rootView, @NonNull Button minusBtn,
      @NonNull Button plusBtn, @NonNull TextView productStock, @NonNull TextView productname,
      @NonNull TextView quntityBtn, @NonNull Button saveBtn) {
    this.rootView = rootView;
    this.minusBtn = minusBtn;
    this.plusBtn = plusBtn;
    this.productStock = productStock;
    this.productname = productname;
    this.quntityBtn = quntityBtn;
  ...
  public static QuantityDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.quntityBtn;
      TextView quntityBtn = ViewBindings.findChildViewById(rootView, id);
      if (quntityBtn == null) {
        break missingId;
      }
      ...
      return new QuantityDialogBinding((ConstraintLayout) rootView, minusBtn, plusBtn, productStock,
          productname, quntityBtn, saveBtn);
    }
