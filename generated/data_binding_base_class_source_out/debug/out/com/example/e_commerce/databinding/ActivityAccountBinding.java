...
public final class ActivityAccountBinding implements ViewBinding {
  ...
  private ActivityAccountBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull BottomNavigationView bottomNavigation,
      @NonNull Button button, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout,
      @NonNull LinearLayout linearLayout2, @NonNull TextView logout, @NonNull TextView textView2,
      @NonNull TextView textView3, @NonNull TextView update) {
  ...
  public static ActivityAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAccountBinding((ConstraintLayout) rootView, bottomNav, bottomNavigation,
          button, imageView, linearLayout, linearLayout2, logout, textView2, textView3, update);
    }
