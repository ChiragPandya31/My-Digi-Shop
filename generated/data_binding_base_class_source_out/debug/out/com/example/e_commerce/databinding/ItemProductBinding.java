...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView image,
      @NonNull TextView label, @NonNull TextView price) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((ConstraintLayout) rootView, image, label, price);
    }
