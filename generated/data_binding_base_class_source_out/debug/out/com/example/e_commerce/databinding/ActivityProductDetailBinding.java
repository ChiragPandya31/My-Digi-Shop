...
public final class ActivityProductDetailBinding implements ViewBinding {
  ...
  private ActivityProductDetailBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button addtocart, @NonNull ImageView imageView, @NonNull TextView productDec) {
  ...
  public static ActivityProductDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.productDec;
      TextView productDec = ViewBindings.findChildViewById(rootView, id);
      if (productDec == null) {
        break missingId;
      }

      return new ActivityProductDetailBinding((ConstraintLayout) rootView, addtocart, imageView,
          productDec);
    }
